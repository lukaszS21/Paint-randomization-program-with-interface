import pygame
from pakiet1 import Funkcje, kolory, kwadrat
import random
...
def paint_2(menu):
    ...
    tryp_rys = False
    p1 = kwadrat.poz(800, 0, 20, 600, screen)
    p2 = kwadrat.poz(980, 0, 20, 600, screen)
    tenczaa = False
        ...
        while True:
            ...
            if e.type == pygame.MOUSEBUTTONDOWN:
                ...
                if e.pos[0] >= 900 and e.pos[0] < 940 and e.pos[1] > 0 and e.pos[1] < 40:
                    color = kolory.VIOLET
                if e.pos[0] >= 940 and e.pos[0] < 980 and e.pos[1] > 0 and e.pos[1] < 40:
                ...
                if e.pos[0] >= 940 and e.pos[0] < 980 and e.pos[1] > 40 and e.pos[1] < 80:
                ...
                if e.pos[0] >= 900 and e.pos[0] < 940 and e.pos[1] > 80 and e.pos[1] < 120:
                    color = kolory.ORANGE
                if e.pos[0] >= 940 and e.pos[0] < 980 and e.pos[1] > 80 and e.pos[1] < 120:
                    color = kolory.TOMATO
                # zólte
                ...
                if e.pos[0] >= 940 and e.pos[0] < 980 and e.pos[1] > 120 and e.pos[1] < 160:
                    color = kolory.KHAKI
                # zielone
            ...
            if jeden == 0:
                # rozowy
                kwadrat.ry(820, 0, screen, kolory.PINK)
                kwadrat.ry(860, 0, screen, kolory.HOTPINK)
                kwadrat.ry(900, 0, screen, kolory.VIOLET)
                kwadrat.ry(940, 0, screen, kolory.DEEPPINK)
                # czerwony
                kwadrat.ry(820, 40, screen, kolory.RED)
                kwadrat.ry(860, 40, screen, kolory.CRIMSON)
                kwadrat.ry(900, 40, screen, kolory.DARKRED)
                kwadrat.ry(940, 40, screen, kolory.LIGHTCORAL)
                # pomaranczowe
                kwadrat.ry(820, 80, screen, kolory.ORANGERED)
                kwadrat.ry(860, 80, screen, kolory.DARKORANGE)
                kwadrat.ry(900, 80, screen, kolory.ORANGE)
                kwadrat.ry(940, 80, screen, kolory.TOMATO)
                # zólte
                kwadrat.ry(820, 120, screen, kolory.GOLD)
                kwadrat.ry(860, 120, screen, kolory.YELLOW)
                kwadrat.ry(900, 120, screen, kolory.LIGHTYELLOW)
                kwadrat.ry(940, 120, screen, kolory.KHAKI)
                # zielone
                kwadrat.ry(820, 160, screen, kolory.GREENYELLOW)
                kwadrat.ry(860, 160, screen, kolory.LIME)
                kwadrat.ry(900, 160, screen, kolory.GREEN)
                kwadrat.ry(940, 160, screen, kolory.SPRINGGREEN)
                # niebieskie

                kwadrat.ry(820, 200, screen, kolory.AQUA)
                kwadrat.ry(860, 200, screen, kolory.STEELBLUE)
                kwadrat.ry(900, 200, screen, kolory.BLUE)
                kwadrat.ry(940, 200, screen, kolory.LIGHTBLUE)
                # brazowe

                kwadrat.ry(820, 240, screen, kolory.SADDLEBROWN)
                kwadrat.ry(860, 240, screen, kolory.SIENNA)
                kwadrat.ry(900, 240, screen, kolory.CHOCOLATE)
                kwadrat.ry(940, 240, screen, kolory.TAN)
                # białe

                kwadrat.ry(820, 280, screen, kolory.GRAY)
                kwadrat.ry(860, 280, screen, kolory.LIGHTGRAY)
                kwadrat.ry(900, 280, screen, kolory.BLACK)
                kwadrat.ry(940, 280, screen, kolory.DARKSLATE)
